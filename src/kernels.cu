...
template
__global__
void hammingWeight<crcham::NaiveCRC>(size_t* weights, NaiveCRC crc, size_t message_bits, size_t error_bits);

template
__global__
void hammingWeight<crcham::TabularCRC>(size_t* weights, TabularCRC crc, size_t message_bits, size_t error_bits);
